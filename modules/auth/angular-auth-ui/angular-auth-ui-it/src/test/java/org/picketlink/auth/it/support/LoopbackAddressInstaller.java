...
/**
 * Ensures required loopback IP addresses exist on {@code lo} before WildFly starts.
 */
public final class LoopbackAddressInstaller {

    private static final List<String> REQUIRED_ADDRESSES = Arrays.asList("127.0.0.110", "127.0.0.111");
